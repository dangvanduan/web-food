                                    ...
                                    <table id="tech-companies-1" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-priority="3">Tên danh mục</th>
                                                <th data-priority="1">Id cha</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM cat ORDER BY cat_id DESC LIMIT $offset, $item_per_page ";
                                            ...
                                            ?>
                                                <tr class="<?php echo $cl ?> gradeX">
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <a href="delete.php?cat_id=<?php echo $arCat['cat_id'] ?>" onclick="return confirm ('Ban co muon xoa danh muc nay khong ?')" title="" class="btn btn-danger"><i class="fe-trash-2"></i> Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
