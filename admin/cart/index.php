                            ...
                            <div class="table-rep-plugin">
                                <div class="table-responsive" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $queryTSD = "SELECT count(*) AS TSD FROM cart ";
                                            ...
                                            $query = "SELECT * FROM cart ORDER BY cart_id DESC LIMIT $offset, $item_per_page  ";
                                            ...
                                            ?>
                                                <tr class="<?php echo $cl ?> gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="edit.php?cart_id=<?php echo $arCart['cart_id'] ?>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                                        <a href="delete.php?cart_id=<?php echo $arCart['cart_id'] ?>" onclick="return confirm ('Ban co muon xoa danh muc nay khong ?')" title="" class="btn btn-danger"><i class="fe-trash-2"></i> Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
