        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="payment-content" ng-controller="orderController" ng-init="initCheckoutController()">
                    ...
                    <form class="payment-block clearfix" id="checkout-container" method="POST">
                        <?php
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 payment-step step2">
                            ...
                            <div class="step-preview clearfix">
                                ...
                                if(isset($_SESSION['sum_final'])){
                                    $sum_final=$_SESSION['sum_final'];                                    
                                }
                                ...
                                if (isset($_SESSION['users'])) {
                                    ...
                                    if (isset($_POST['user_name'])) {
                                        ...
                                        } else if($vanchuyen=="paypal"){
                                            echo '<script type="text/javascript"> alert("Đặt hàng thành công");</script>';
                                            echo  '<script type="text/javascript">
                                            function Redirect() {
                                            window.location="https://www.paypal.com/vn/signin";
                                            }
                                            Redirect();
                                            </script>';
                                        }   
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 payment-step step1">
                            ...
                            <div class="step-preview">
                                <div class="cart-info">
                                    ...
                                    <br>
                                    <div class="vanchuyenhang">
                                        
                                            <input type="radio" id="vanchuyen" name="vanchuyen" value="giaohang" checked>Thanh toán khi giao hàng<br>
                                            <input type="radio" id="vanchuyen" name="vanchuyen" value="paypal">Thanh toán qua <image src="Uploads/shop97/images/paypal.png" width="70px" height="70px"><br>
                                    </div>
